    ...
    function(declare, array, LocateButton, Locator, PictureMarkerSymbol, InfoTemplate, esriLang, Search, lang, on, dom, registry, domConstruct, query,
      ...
      return declare([BaseWidget], {
        ...
        postCreate: function() {
            ...
            m_lyrAllFacilities = this.map.getLayer("Nodos_Ruta_4702");;
            ...
            sources = [{
              ...
              highlightSymbol: new PictureMarkerSymbol("https://js.arcgis.com/3.27/esri/dijit/images/sdk_gps_location.png", 29, 29).setOffset(9, 18)
